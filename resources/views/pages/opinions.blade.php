...
<div class="content">
	...
	<div class="container">
        <div class="button-line"><a href="/" class="button-line__button button-rounding button-rounding_trans-big button-rounding_trans-hlight">Назад
            ...
            <a class="button-line__button button-line__button_right button-rounding button-rounding_trans-big button-rounding_trans-light" href="{{$settings->vk_group}}" target="_blank">Написать отзыв</a>
        </div>
    </div>
					...
					<div class="reviews-block__reviews-card">
						<div class="reviews-block__header-wrapper">
							<div class="reviews-block__header"><a href="{{$r->user_link}}" target="_blank">
									<div class="reviews-block__ava-wrapper"><img src="{{$r->user_avatar}}" alt="" class="reviews-block__ava-img"></div>{{$r->username}}</a>
						...
						<div class="reviews-block__reviews-file">
							<div class="reviews-block__reviews-file-header text-block text-block_color_gray">
								...
								@endif
								<div class="reviews-block__reviews-link text-block"><a href="{{$r->opinion_link}}" target="_blank" class="text-block__link">Оригинал отзыва</a></div>
							</div>
							@if(isset($r->photo) && $r->photo != ''))
