                ...
                <div class="table-col col-xs-12 col-sm-6 col-md-6 col-lg-6">
                    <table class="main-table">
                        ...
                        <tr>
                            ...
                            <th class="main-table__th main-table__th_center"><img src="https://219316.selcdn.ru/egger/egg-icon_gold.png" alt="" class="main-table__icon-img"></th>
                            <th class="main-table__th main-table__th_center"><img src="https://219316.selcdn.ru/egger/money__icon_yellow.png" alt="" class="main-table__icon-img"></th>
                        </tr>
                        </thead>
                        <tbody>
							...
							<tr class="main-table__tbody-tr">                                                                                                                                                                                                                                                                                                                                               <tr class="main-table__tbody-tr">
                                ...
                                <td class="main-table__td main-table__td_center"><span>{{$u->profit}}<span class="rouble">p</span></span></td>
                            </tr>
							@endforeach                                         
						</tbody>
                    </table>
